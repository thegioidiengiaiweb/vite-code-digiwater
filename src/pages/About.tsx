    ...
    <>
      ...
      <section className="relative pt-40 pb-20 bg-slate-900 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="https://cdn.thegioidiengiai.com/thegioidiengiaicdn/logo-digiwater/nghien-cuu-chuyen-sau-nguon-nuoc-tai-viet-nam.png" alt="Research Background" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
        </div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/3 h-full opacity-[0.05] grayscale pointer-events-none hidden lg:block">
            <img src="https://cdn.thegioidiengiai.com/thegioidiengiaicdn/logo-digiwater/ban-do-vn.png" alt="Vietnam Map Background" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className={`why-card group relative p-8 md:p-10 rounded-[2.5rem] bg-white border shadow-sm transition-all duration-500 hover:-translate-y-3 flex flex-col items-center text-center ${activeCard === 0 ? 'is-active border-sky-200 shadow-2xl' : 'border-slate-100'}`}>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-slate-900 group-hover:text-sky-600 transition-colors">Nguồn nước có đặc tính khác nhau theo từng khu vực</h3>
              <p className="text-slate-500 leading-relaxed text-justify text-sm md:text-base">
                Nguồn nước tại Việt Nam rất đa dạng: từ nước giếng khoan ở nông thôn, nước nhiễm phèn vùng đồng bằng đến nước máy đô thị. Mỗi khu vực có cấu trúc khoáng chất và đặc tính hóa học khác nhau.
              </p>
              <div className="absolute top-6 right-8 text-slate-100 font-black text-6xl group-hover:text-sky-50 transition-colors duration-500 select-none -z-10">01</div>
            </div>

            <div className={`why-card group relative p-8 md:p-10 rounded-[2.5rem] bg-white border shadow-sm transition-all duration-500 hover:-translate-y-3 flex flex-col items-center text-center ${activeCard === 1 ? 'is-active border-sky-200 shadow-2xl' : 'border-slate-100'}`}>
              <div className="relative mb-8">
                <div className="absolute inset-0 bg-sky-400/20 blur-2xl rounded-full scale-0 group-hover:scale-150 transition-transform duration-700"></div>
                <div className="w-20 h-20 bg-slate-900 rounded-3xl flex items-center justify-center text-sky-400 group-hover:bg-sky-500 group-hover:text-white transition-all duration-500 shadow-xl relative z-10">
                  <ShieldCheck size={36} />
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-slate-900 group-hover:text-sky-600 transition-colors">Không phải công nghệ xử lý nào cũng phù hợp</h3>
              <p className="text-slate-500 leading-relaxed text-justify text-sm md:text-base">
                Nhiều công nghệ xử lý nước được phát triển dựa trên điều kiện nguồn nước của các quốc gia có hệ thống cấp nước ổn định. Khi áp dụng trực tiếp vào Việt Nam, hiệu suất có thể bị ảnh hưởng nghiêm trọng.
              </p>
              <div className="absolute top-6 right-8 text-slate-100 font-black text-6xl group-hover:text-sky-50 transition-colors duration-500 select-none -z-10">02</div>
            </div>

            <div className={`why-card group relative p-8 md:p-10 rounded-[2.5rem] bg-white border shadow-sm transition-all duration-500 hover:-translate-y-3 flex flex-col items-center text-center ${activeCard === 2 ? 'is-active border-sky-200 shadow-2xl' : 'border-slate-100'}`}>
              <div className="relative mb-8">
                <div className="absolute inset-0 bg-sky-400/20 blur-2xl rounded-full scale-0 group-hover:scale-150 transition-transform duration-700"></div>
                <div className="w-20 h-20 bg-slate-900 rounded-3xl flex items-center justify-center text-sky-400 group-hover:bg-sky-500 group-hover:text-white transition-all duration-500 shadow-xl relative z-10">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-slate-900 group-hover:text-sky-600 transition-colors">Giải pháp xử lý phải dựa trên dữ liệu phân tích</h3>
              <p className="text-slate-500 leading-relaxed text-justify text-sm md:text-base">
                Khi áp dụng trực tiếp vào nguồn nước tại Việt Nam, hiệu suất xử lý có thể giảm và ảnh hưởng đến tuổi thọ thiết bị. Vì vậy cần phân tích nguồn nước thực tế trước khi thiết kế giải pháp.
              </p>
              <div className="absolute top-6 right-8 text-slate-100 font-black text-6xl group-hover:text-sky-50 transition-colors duration-500 select-none -z-10">03</div>
            </div>
          </div>
      ...
      <section className="py-10 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-sky-400 hover:shadow-[0_0_25px_rgba(14,165,233,0.2)] transition-all duration-300 reveal">
              <div className="text-sky-500 mb-4">
                <FlaskConical size={32} />
              </div>
              <h4 className="font-bold mb-2">Khoa học & Kiểm chứng</h4>
              <p className="text-sm text-slate-500 text-justify">Mọi kết luận đều dựa trên dữ liệu đo đạc thực tế từ phòng thí nghiệm.</p>
            </div>
            <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-sky-400 hover:shadow-[0_0_25px_rgba(14,165,233,0.2)] transition-all duration-300 reveal delay-100">
              <div className="text-sky-500 mb-4">
                <ShieldCheck size={32} />
              </div>
              <h4 className="font-bold mb-2">Minh bạch & Trách nhiệm</h4>
              <p className="text-sm text-slate-500 text-justify">Công khai các chỉ số và chịu trách nhiệm về tính chính xác của kết quả phân tích.</p>
            </div>
            <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-sky-400 hover:shadow-[0_0_25px_rgba(14,165,233,0.2)] transition-all duration-300 reveal delay-200">
              <div className="text-sky-500 mb-4">
                <ClipboardCheck size={32} />
              </div>
              <h4 className="font-bold mb-2">Chuẩn hóa & Ứng dụng</h4>
              <p className="text-sm text-slate-500 text-justify">Xây dựng tiêu chuẩn xử lý nước phù hợp với đặc thù từng địa phương.</p>
            </div>
            <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-sky-400 hover:shadow-[0_0_25px_rgba(14,165,233,0.2)] transition-all duration-300 reveal delay-300">
              <div className="text-sky-500 mb-4">
                <Users size={32} />
              </div>
              <h4 className="font-bold mb-2">Phục vụ cộng đồng</h4>
              <p className="text-sm text-slate-500 text-justify">Nâng cao nhận thức về nước sạch và bảo vệ sức khỏe người dân Việt Nam.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="p-10 rounded-3xl bg-white border border-sky-200 shadow-[0_0_30px_rgba(14,165,233,0.15)] hover:border-sky-400 hover:shadow-[0_0_40px_rgba(14,165,233,0.3)] transition-all duration-300 reveal">
            ...
            <div className="p-10 rounded-3xl bg-white border border-sky-200 shadow-[0_0_30px_rgba(14,165,233,0.15)] hover:border-sky-400 hover:shadow-[0_0_40px_rgba(14,165,233,0.3)] transition-all duration-300 reveal delay-200">
              <h3 className="text-2xl font-bold mb-6 flex items-center text-slate-800">
