...
const Home: React.FC = () => {
  ...
  const testimonials = [
    {
      quote: "Nguồn nước tại Việt Nam có sự khác biệt rõ rệt giữa từng vùng địa lý. Việc phân tích chính xác các chỉ số hóa lý và vi sinh là bước nền tảng để xây dựng giải pháp xử lý nước phù hợp và bền vững.",
    ...
    {
      quote: "Chúng tôi tin rằng mỗi giải pháp xử lý nước hiệu quả đều phải bắt đầu từ sự thấu hiểu nguồn nước. Đó cũng là lý do DigiWater được xây dựng như một nền tảng nghiên cứu và phân tích dữ liệu nguồn nước tại Việt Nam.",
    ...
    {
      quote: "Nghiên cứu nguồn nước là nền tảng quan trọng để đảm bảo các thiết bị xử lý nước vận hành hiệu quả, ổn định và bền vững trong suốt vòng đời sử dụng.",
    ...
    {
      quote: "Mỗi mẫu nước đều mang những đặc điểm riêng biệt. Khi được phân tích và chẩn đoán chính xác, chúng ta có thể lựa chọn giải pháp xử lý tối ưu cho từng công trình.",
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-20 pb-10 lg:pb-0 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-slate-900">
          <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_50%_50%,rgba(14,165,233,0.15),transparent_70%)]"></div>
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-900/50 to-slate-900"></div>
          <div className="water-overlay"></div>
          <div className="absolute inset-0 opacity-40">
            <CanvasParticles color="rgba(56, 189, 248, 0.3)" count={100} speed={0.5} size={2} />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center lg:gap-16">
            <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-12">
              <div className="flex flex-col items-center lg:items-start mb-12">
                <div className="hero-logo-wrapper">
                  ...
                  <img src="https://cdn.thegioidiengiai.com/thegioidiengiaicdn/logo-digiwater/digiwater-logo-01.png" alt="DigiWater Logo" className="hero-logo-img" referrerPolicy="no-referrer" />
                </div>
              </div>
            ...
            <div className="lg:w-1/2 flex justify-center items-center relative reveal delay-200 -mt-6 lg:mt-0">
              <div className="hero-image-container">
                <img src="https://cdn.thegioidiengiai.com/thegioidiengiaicdn/logo-digiwater/hero-digiwater.png" alt="DigiWater Hero" className="hero-image-3d" referrerPolicy="no-referrer" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-20 pb-10 bg-white">
        <div className="container mx-auto px-4 text-center reveal">
          <div className="max-w-4xl mx-auto">
            <div className="relative p-8 md:p-10 rounded-2xl border border-sky-200 bg-sky-50/30 text-justify reveal hover:shadow-[0_0_30px_rgba(14,165,233,0.2)] hover:border-sky-400 transition-all duration-500 hover:-translate-y-1 cursor-default group">
            ...
            <p className="text-lg text-slate-600 leading-relaxed mt-4 text-justify reveal">
      ...
      <section className="pt-10 pb-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
            <div className="lg:w-5/12 flex justify-center reveal">
              <div className="vn-map-container relative w-full max-w-md mx-auto">
                <img src="https://cdn.thegioidiengiai.com/thegioidiengiaicdn/logo-digiwater/ban-do-vn.png" alt="Bản đồ Việt Nam" className="w-full h-auto drop-shadow-2xl" referrerPolicy="no-referrer" />
                
                <div 
                  className={`map-marker north ${activeRegion === 'north' ? 'active' : ''}`} 
                ...
                <div 
                  className={`map-marker central ${activeRegion === 'central' ? 'active' : ''}`} 
                ...
                <div 
                  className={`map-marker south ${activeRegion === 'south' ? 'active' : ''}`} 
            ...
            <div className="lg:w-7/12 space-y-6 reveal delay-200">
              <div 
                className={`region-info p-6 rounded-2xl border transition-all duration-300 ${activeRegion === 'north' ? 'border-sky-400 bg-sky-50 shadow-md' : 'border-slate-100'}`}
                onClick={() => setActiveRegion('north')}
              >
                ...
                <ul className="space-y-2 text-slate-600 text-justify">
                  <li className="flex items-start"><span className="mr-2">•</span> Nước có độ cứng cao, hàm lượng Canxi và Magie lớn.</li>
                  <li className="flex items-start"><span className="mr-2">•</span> Dễ gây đóng cặn trong thiết bị vệ sinh và gia dụng.</li>
                  <li className="flex items-start"><span className="mr-2">•</span> Khoáng chất cao ở một số khu vực địa chất đá vôi.</li>
                </ul>
              </div>
              <div 
                className={`region-info p-6 rounded-2xl border transition-all duration-300 ${activeRegion === 'central' ? 'border-sky-400 bg-sky-50 shadow-md' : 'border-slate-100'}`}
                onClick={() => setActiveRegion('central')}
              >
                <h3 className="text-xl font-bold mb-3 text-sky-700 flex items-center">
                  <span className="w-3 h-3 rounded-full bg-sky-500 mr-3"></span>
                ...
                <ul className="space-y-2 text-slate-600 text-justify">
                  <li className="flex items-start"><span className="mr-2">•</span> Nước nhiễm mặn ở vùng ven biển, nước lợ.</li>
                  <li className="flex items-start"><span className="mr-2">•</span> Nguồn nước khoáng cao, biến động theo mùa rõ rệt.</li>
                  <li className="flex items-start"><span className="mr-2">•</span> Một số khu vực có hàm lượng kim loại nặng đặc thù.</li>
                </ul>
              </div>
              <div 
                className={`region-info p-6 rounded-2xl border transition-all duration-300 ${activeRegion === 'south' ? 'border-sky-400 bg-sky-50 shadow-md' : 'border-slate-100'}`}
                onClick={() => setActiveRegion('south')}
              >
                <h3 className="text-xl font-bold mb-3 text-sky-700 flex items-center">
                  <span className="w-3 h-3 rounded-full bg-sky-500 mr-3"></span>
                ...
                <ul className="space-y-2 text-slate-600 text-justify">
                  <li className="flex items-start"><span className="mr-2">•</span> Nước nhiễm phèn, hàm lượng Sắt (Fe) và Mangan (Mn) cao.</li>
                  <li className="flex items-start"><span className="mr-2">•</span> Nước giếng tầng nông dễ có tạp chất hữu cơ.</li>
                  <li className="flex items-start"><span className="mr-2">•</span> Độ pH thường thấp (tính acid).</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 reveal delay-200">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <img src="https://cdn.thegioidiengiai.com/thegioidiengiaicdn/logo-digiwater/trung-tam-nghien-cuu-nuoc-thu-thap-phan-tich-cac-nguon-nuoc-o-nhiem-tai-viet-nam.jpg" alt="Trung tâm nghiên cứu nguồn nước DigiWater" className="w-full h-auto" referrerPolicy="no-referrer" />
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto reveal">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-slate-600">
              <div className="space-y-6">
                <p className="text-justify font-bold">DigiWater quy tụ các chuyên gia giàu kinh nghiệm trong lĩnh vực khoa học môi trường nước:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      <span className="text-sky-500 mr-3 font-bold">•</span>
                      <span>Phân tích hóa lý</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-sky-500 mr-3 font-bold">•</span>
                      <span>Vi sinh nguồn nước</span>
                    </li>
                  </ul>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-sky-500 mr-3 font-bold">•</span>
                      <span>Công nghệ lọc nước</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-sky-500 mr-3 font-bold">•</span>
                      <span>Thiết bị y tế và môi trường</span>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <Check className="text-sky-500 mr-3" size={18} />
                    <span>Nghiên cứu đặc điểm nguồn nước theo vùng địa lý</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="text-sky-500 mr-3" size={18} />
                    <span>Phân tích và đánh giá mẫu nước</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="text-sky-500 mr-3" size={18} />
                    <span>Xác định các chỉ tiêu và nguy cơ ô nhiễm</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="text-sky-500 mr-3" size={18} />
                    <span>Chuẩn hóa giải pháp xử lý nước cho từng công trình</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="reveal mt-12">
            ...
            <div className="relative max-w-4xl mx-auto overflow-hidden px-4 py-8">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <h5 className="font-bold text-slate-900 text-lg">{testimonials[currentTestimonial].author}</h5>
                      <p className="text-sm text-sky-600 font-medium">{testimonials[currentTestimonial].role}</p>
                    </div>
                  </div>
                </motion.div>
              </AnimatePresence>
              <div className="flex justify-center gap-2 mt-8">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${currentTestimonial === index ? 'bg-sky-500 w-8' : 'bg-slate-300'}`}
                  />
                ))}
              </div>
            </div>
      ...
      <section className="py-10 relative overflow-hidden bg-slate-50">
        <div className="absolute inset-0 pointer-events-none opacity-30">
          ...
          <div className="absolute inset-0 opacity-20">
            <CanvasParticles color="rgba(14, 165, 233, 0.3)" count={60} speed={0.3} size={1.5} />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed">
                ...
                <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-sky-100 shadow-sm">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <li className="flex items-center text-sm">
                      <Check className="w-4 h-4 text-sky-500 mr-2" />
                      Tiêu chuẩn an toàn vi sinh
                    </li>
                    <li className="flex items-center text-sm">
                      <Check className="w-4 h-4 text-sky-500 mr-2" />
                      Tiêu chuẩn phân tích hóa lý nguồn nước
                    </li>
                  </ul>
                </div>
            ...
            <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6 reveal delay-300">
              <div className="scientific-card group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-[0_0_30px_rgba(14,165,233,0.2)] hover:border-sky-400 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="icon-container mb-6 text-sky-500 relative">
                    ...
                    <FlaskConical className="w-12 h-12 relative z-10 icon-glow" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-sky-600 transition-colors">Phân tích hóa lý nguồn nước</h3>
                  <p className="text-sm text-slate-500">Đánh giá các chỉ tiêu hóa học và khoáng chất trong mẫu nước.</p>
                </div>
              </div>
              ...
              <div className="scientific-card group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-[0_0_30px_rgba(14,165,233,0.2)] hover:border-sky-400 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="icon-container mb-6 text-sky-500 relative">
                    <div className="absolute inset-0 bg-sky-400/20 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <Microscope className="w-12 h-12 relative z-10 icon-glow" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-sky-600 transition-colors">Phân tích vi sinh</h3>
                  <p className="text-sm text-slate-500">Kiểm tra các chỉ số vi sinh nhằm xác định mức độ an toàn của nguồn nước.</p>
                </div>
              </div>
              ...
              <div className="scientific-card group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-[0_0_30px_rgba(14,165,233,0.2)] hover:border-sky-400 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="icon-container mb-6 text-sky-500 relative">
                    <div className="absolute inset-0 bg-sky-400/20 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <ShieldCheck className="w-12 h-12 relative z-10 icon-glow" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-sky-600 transition-colors">Kiểm định chất lượng nước</h3>
                  <p className="text-sm text-slate-500">Đánh giá tổng thể chất lượng nước dựa trên các tiêu chuẩn khoa học.</p>
                </div>
              </div>
              ...
              <div className="scientific-card group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-[0_0_30px_rgba(14,165,233,0.2)] hover:border-sky-400 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="icon-container mb-6 text-sky-500 relative">
                    <div className="absolute inset-0 bg-sky-400/20 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <ClipboardCheck className="w-12 h-12 relative z-10 icon-glow" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-sky-600 transition-colors">Chuẩn hóa quy trình phân tích</h3>
                  <p className="text-sm text-slate-500">Áp dụng các phương pháp phân tích chuẩn hóa trong phòng thí nghiệm.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              <div className="process-step text-center reveal">
                <div className="w-16 h-16 rounded-full bg-white border-4 border-sky-500 flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <span className="text-xl font-bold text-sky-600">01</span>
                </div>
                <h4 className="font-bold mb-2">Đăng ký xét nghiệm</h4>
                <p className="text-sm text-slate-500 text-center"> Khách hàng đăng ký dịch vụ xét nghiệm nước với DigiWater qua hotline.</p>
              </div>
              <div className="process-step text-center reveal delay-100">
                <div className="w-16 h-16 rounded-full bg-white border-4 border-sky-500 flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <span className="text-xl font-bold text-sky-600">02</span>
                </div>
                <h4 className="font-bold mb-2">Tiếp nhận mẫu nước</h4>
                <p className="text-sm text-slate-500 text-center">Kỹ thuật viên DigiWater đến tận nơi lấy mẫu nước hoặc thông qua chuyển phát nhanh.</p>
              </div>
              <div className="process-step text-center reveal delay-200">
                <div className="w-16 h-16 rounded-full bg-white border-4 border-sky-500 flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <span className="text-xl font-bold text-sky-600">03</span>
                </div>
                <h4 className="font-bold mb-2">Phân tích mẫu nước</h4>
                <p className="text-sm text-slate-500 text-center">Phòng thí nghiệm DigiWater tiến hành phân tích các chỉ tiêu cần thiết bằng thiết bị chuyên dụng hiện đại.</p>
              </div>
              <div className="process-step text-center reveal delay-300">
                <div className="w-16 h-16 rounded-full bg-white border-4 border-sky-500 flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <span className="text-xl font-bold text-sky-600">04</span>
                </div>
                <h4 className="font-bold mb-2">Trả kết quả</h4>
                <p className="text-sm text-slate-500 text-center">Kết quả xét nghiệm được gửi qua ZNS, kèm theo tư vấn giải pháp xử lý nước tối ưu từ chuyên gia.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-0 reveal">
            <div className="ecosystem-block ecosystem-tgdg p-8 bg-white rounded-3xl shadow-lg border border-slate-200 text-center w-full max-w-sm">
            ...
            <div className="ecosystem-block ecosystem-digiwater p-1 rounded-3xl shadow-lg z-10 text-center w-full max-w-sm">
            ...
            <div className="ecosystem-block ecosystem-tglt p-8 bg-white rounded-3xl shadow-lg border border-slate-200 text-center w-full max-w-sm">
        ...
        <div className="container mx-auto px-4 relative z-10 py-20">
          <div className="max-w-4xl mx-auto text-center reveal">
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-sm md:text-base font-medium text-sky-200/70">
              <div className="flex items-center">
                <span className="text-emerald-400 mr-2">✓</span> Phân tích hóa lý
              </div>
              <div className="flex items-center">
                <span className="text-emerald-400 mr-2">✓</span> Kiểm tra vi sinh
              </div>
              <div className="flex items-center">
                <span className="text-emerald-400 mr-2">✓</span> Kết quả chi tiết
              </div>
            </div>
          </div>
        </div>
